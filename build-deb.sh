...
TMPDIR=/tmp/balance.lv2-${DEBRELEASE}
rm -rf ${TMPDIR}
...
lintian -i --pedantic ${TMPDIR}/balance.lv2_${DEBRELEASE}_*.changes \
	| tee /tmp/balance.issues

echo
ls ${TMPDIR}/balance_${DEBRELEASE}_*.changes
echo
echo dput rg42 ${TMPDIR}/balance_${DEBRELEASE}_*.changes
